...
class Decision_Graph_Agent:
	...
	def generate_node(self, state: GraphState) -> GraphState:
		...
		if state["source"] == "web":
			warning = "\n\n⚠️IMPORTANT NOTICE: I haven't found any information on this in my official medical database. This response was generated by searching the Internet to provide you with general context, so it may not be accurate or reliable. Please ALWAYS consult your obstetrician if you have any questions.⚠️"
			out = out + warning
